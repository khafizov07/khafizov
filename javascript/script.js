...
const flwTitle = [...document.querySelectorAll('.followers__title span')]
const subsBtn = document.querySelector('.subs__button')
const leftButton = document.querySelector('.left__button')
const titleView = document.querySelector('.left__title')
...
subsBtn.addEventListener('click', () => {
    if (subsBtn.innerHTML === 'Subscribe') {
        subsBtn.innerHTML = 'Signed'
        subsBtn.style.background = 'red'
    } else if (subsBtn.innerHTML === 'Signed') {
        subsBtn.innerHTML = 'Subscribe'
        subsBtn.style.background = '#0A84FF'
    }
})

leftButton.addEventListener('click', () => {
    if (leftButton.innerHTML === 'Place a bid') {
        leftButton.innerHTML = 'Cancel'
        leftButton.style.background = 'red'
        
    } else if (leftButton.innerHTML === 'Cancel') {
        leftButton.innerHTML = 'Place a bid'
        leftButton.style.background = '#0A84FF'
    }
})

titleView.addEventListener('click', () => {
    if (titleView.innerHTML === 'View artwork') {
        titleView.innerHTML = 'No illustration yet☹'
